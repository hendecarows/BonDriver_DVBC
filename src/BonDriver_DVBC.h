...
// This code from https://github.com/u-n-k-n-o-w-n/BonDriverProxy_Linux
...
class cBonDriverDVB : public IBonDriver2 {
	...
	static void *TsmfParser(LPVOID pv);
